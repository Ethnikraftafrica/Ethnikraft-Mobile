...
export const LightTheme: ThemeColors = {
  ...
  drawerBorder: 'rgba(102, 37, 2, 0.15)',
  success: '#0AD24F',
  danger: '#C92929',
  warning: '#F59E0B',
  info: '#0799C1',
...
export const DarkTheme: ThemeColors = {
  ...
  secondary: '#6B8E23',
  accentGold: '#FFD79E',
  navBackgroundGradient: ['#1B1D1F', '#151616', '#101213'],
  navBorder: 'rgba(209, 153, 90, 0.25)',
  navActiveText: '#FFFCF4',
  navActiveIcon: '#D1995A',
  navActiveIndicator: '#C46C27',
  navInactiveText: '#808080',
  navInactiveIcon: '#808080',
  headerBackground: '#151616',
  headerText: '#FFFCF4',
  drawerBackgroundGradient: ['#1B1D1F', '#151616', '#101213'],
  drawerBorder: 'rgba(209, 153, 90, 0.25)',
  success: '#0AD24F',
  danger: '#C92929',
  warning: '#F59E0B',
  info: '#0799C1',
